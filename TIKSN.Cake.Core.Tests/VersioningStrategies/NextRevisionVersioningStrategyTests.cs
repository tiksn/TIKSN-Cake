...
{
    public class NextRevisionVersioningStrategyTests
    {
        [Theory]
        [InlineData("1.2.3-alpha.1", "1.2.3.1")]
        [InlineData("1.2.3-alpha.12", "1.2.3.1")]
        [InlineData("1.2.3-beta.14", "1.2.3.1")]
        [InlineData("1.2.3-rc.14", "1.2.3.1")]
        [InlineData("1.2.3.4-alpha.1", "1.2.3.5")]
        [InlineData("1.2.3.4-alpha.12", "1.2.3.5")]
        [InlineData("1.2.3.4-beta.14", "1.2.3.5")]
        [InlineData("1.2.3.4-rc.14", "1.2.3.5")]
        [InlineData("1.2.0", "1.2.0.1")]
        ...
        public void GetNextVersionTest(string latestVersionString, string expectedNextVersionString)
        {
            ...
            var strategy = new NextRevisionVersioningStrategy(timeProvider);
